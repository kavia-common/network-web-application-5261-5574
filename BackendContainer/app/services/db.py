...
def _get_client() -> MongoClient:
    ...
    if _client is None:
        ...
        try:
            # TODO: TEMP: Hardcoded for connectivity testing; revert to Config.MONGO_URI after validation
            # NOTE: Replace the URI below with the one you want to test against.
            # Example formats:
            #   "mongodb://localhost:27017"
            #   "mongodb+srv://<user>:<pass>@<cluster-url>/?retryWrites=true&w=majority"
            _client = MongoClient("mongodb+srv://db_user:vettel%402012@cluster0.htz84wq.mongodb.net/network?retryWrites=true&w=majority", uuidRepresentation="standard")
